...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("maciejewski.pawel@o2.pl");
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/maciejewski.pawel@o2.pl/boards?key=test&token=test&fields=name,id&lists=all");
